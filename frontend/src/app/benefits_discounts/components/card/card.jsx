...
export default function Card({title, location, link, pic, start_date, index, offer_description, saved, type, distance, toggleCardSaved}) {
    ...
    return (
            <div className="border flex flex-col justify-evenly rounded-3xl bg-[#F6F2E9] w-80 h-56">
                <Link href={{
                    ...
                    query: { title, location, link, pic, start_date, offer_description, index, saved, type, distance, toggleCardSaved }
                    }}>
                ...
                <div className='flex flex-row w-full pl-5 pr-5'>
                    <div className='flex flex-col justify-center'>
                        ...
                        <p className={`font-bold text-sm ${prozaLibre.className} text-[#214933]`}>{start_date}</p>
