...
const Profile = () => {
  ...
  return (
    <div className=" text-white p-8 rounded-lg w-full mx-auto;
 ">
      {/* Header */}
      <div className="flex items-center gap-4 mb-8">
        <UserIcon className="h-20 w-20 text-white" />
        <h1 className="text-white text-[40px] font-custom mb-6">Profile</h1>
      </div>

      

      {/* Form Section */}
      <div className="bg-[#F6F2E9] p-6 rounded-lg mb-8">
        {/* Name Input */}
        <div className="mb-4 ">
          ...
          <div className="flex gap-4 w-10/12 ">
            <input
              ...
              value={userName}
              readOnly
              className="flex-1 p-2 border text-gray-500 w-3/4 rounded-full bg-white focus:outline-none"
            />
            <button className="bg-green-800 text-white px-4 py-2  w-1/4 rounded-full hover:bg-green-700">
              Confirm
            </button>
          </div>
        </div>
        ...
        <div className="mb-4">
          ...
          <div className="flex gap-4 w-10/12">
            ...
            <input
              ...
              value={phoneNumber}
              readOnly
              className="flex-1 p-2 border rounded-full  w-3/4 text-gray-500 bg-white focus:outline-none"
            />
            <button className="bg-green-800 text-white px-4 py-2  w-1/4 rounded-full hover:bg-green-700">
              Confirm
            </button>
